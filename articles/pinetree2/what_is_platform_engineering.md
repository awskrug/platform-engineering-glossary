...
tags: platformengineering,platform,idp
...
초기 플랫폼 구축 노력은 가장 성숙한 단계인 {{ Internal Developer Portal }}(Internal Developer Portal: IDP)에서 시작되는 경우가 많습니다. IDP는 엄선된 도구, 기능 및 프로세스 세트를 제공합니다. 전문가들은 개발팀이 쉽게 사용할 수 있도록 선별하고 패키징합니다.
